...
{
    public class U2NetHumanProcessor : DnnNetProcessor
    {
        protected override string RemoteModelUrl => "https://storage.googleapis.com/ailia-models/u2net-human-seg/u2net-human-seg.onnx";
